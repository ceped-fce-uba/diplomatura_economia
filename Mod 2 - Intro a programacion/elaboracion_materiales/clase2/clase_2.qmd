...
Fíjense que el cálculo anterior calcula el promedio de ocupados en todos los sectores y en todos los momentos del tiempo. Probablemente esto no sea lo que queríamos hacer. Para solucionar este problema, la siguiente función, la gran estrella de `dplyr`...
