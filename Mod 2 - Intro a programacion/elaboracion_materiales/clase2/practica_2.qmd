...
a) Vamos a usar a continuación la variable "Asalariados registrados en el sector privado" de la base del SIPA. Filtren para desechar el resto y vean su contenido. Carguen también la base *regiones.csv*.

```{r}

```

b) Hagan un join entre la base de asalariados por provincia y la de regiones. [Obviamente, lo ideal sería asignar ciertos partidos de la provincia de Buenos Aires a la región Gran Buenos Aires y el resto de la provincia a la región pampeana. Pero a los fines de este ejercicio estamos bien.]{.aside}
