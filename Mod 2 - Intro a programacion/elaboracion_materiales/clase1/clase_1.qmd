...
typeof(A)
```
Double es una abreviación de "doble precisión" y el nombre tiene que ver con la historia de las ciencias de la computación (¡lo cual excede los límites de este curso!). En la práctica van a trabajar siempre con este tipo de dato numérico.
...
## Advertencia
Los lenguajes de programación, incluyendo a R, fueron mayormente desarrollados en países donde utilizan el punto (.) como separador decimal, que lo establecieron como estándar. Por eso hoy en día se estandarizó e
:::
...
| Tipo | Descripción | Ejemplo | Función creadora |
|------|-------------|---------|------------------|
...
| List | Colección de elementos de diferentes tipos | Heterogénea, anidable |
| Matrix | Tabla de elementos del mismo tipo | Bidimensional, homogénea |
| Data Frame | Tabla de datos de diferentes tipos | Columnas pueden ser de diferentes tipos |
