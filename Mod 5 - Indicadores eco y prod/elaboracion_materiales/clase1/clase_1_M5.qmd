...
```{r}
#| echo: true
#| fig-cap: "Reservas Internacionales del BCRA"
...
## Circulación monetaria en dólares
...
```{r}
ggplot(df_circ_tc, aes(x = fecha, y = circulacion_dolares)) +
  geom_line(color = "#4E79A7", size = 1.5) +
  theme_fivethirtyeight() +
  labs(
    title = "Circulación monetaria",
