...
base <- read_csv("Mod 3 - Econ Internacional/elaboracion_materiales/clase4/dataset_2025-05-26T03_18_36.490488675Z_DEFAULT_INTEGRATION_IMF.STA_BOP_AGG_9.0.1.csv")
