...
base <- read_csv("Mod 3 - Econ Internacional/elaboracion_materiales/clase4/bases/dataset_2025-05-26T03_18_36.490488675Z_DEFAULT_INTEGRATION_IMF.STA_BOP_AGG_9.0.1.csv")

indicadores <- base$INDICATOR %>% 
  unique() %>% as.tibble()

cpi <- read_csv("Mod 3 - Econ Internacional/elaboracion_materiales/clase4/bases/CPI-U_BLS.csv") %>% 
